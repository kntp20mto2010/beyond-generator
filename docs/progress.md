...
> ⚠️ **モデル運用メモ(2026-06-13〜・暫定)**: fable5が一時停止中のため、当面の**メインモデルはopus**。
> 09のモデル戦略でfable5に割り当てた役割(仕様/アーキ判断・支柱の難所実装・**視覚検証**・横断バグ)はopusが代行する。
> fable5復帰後は09の本来配分に戻す。詳細は [09-model-strategy.md](spec/09-model-strategy.md) 冒頭の暫定運用節。
